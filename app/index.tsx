...
import { getCredentials, getProfile, getSchedule, hasAcceptedDisclaimer, saveProfile, saveSchedule } from '../utils/storage';

export default function IndexScreen() {
    const router = useRouter();

    const [authData, setAuthData] = useState<{ rut: string | null; pass: string | null; server: string }>({ rut: null, pass: null, server: 'usm.cl' });
    ...
    const handleSyncSuccess = async (data: { scheduleHtml: string; profileHtml: string }) => {
        try {
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.loaderContainer}>
                        ...
                        <Text style={styles.loadingText}>
                            {needsSync ? 'Iniciando sesión en SIGA...' : 'Iniciando SIGApp...'}
                        </Text>
                    </View>
                </View>
