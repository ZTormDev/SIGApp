    ...
    try {
      ...
      if (success) {
        ...
        Alert.alert(
          ...
          `Deberías ver una notificación de prueba ahora.\n\nNotificaciones programadas: ${count}`,
        );
      } else {
        Alert.alert(
          "❌ Sin permisos",
          "No se pudo enviar la notificación. Asegúrate de haber otorgado permisos de notificación en la configuración del dispositivo.",
        );
      }
    } catch (error) {
      Alert.alert(
    ...
    >
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          />
          <SettingsItem icon="school-outline" label="Universidad" value="USM" />
        </Animated.View>
