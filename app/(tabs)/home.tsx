...
import { DEMO_DATA } from "../../utils/scheduleConstants";
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (
        profileData &&
        (profileData.fullName || profileData.rut || profileData.career)
      ) {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Animated.View
            ...
            style={styles.shadowWrapperWrapper}
          >
          ...
          <Animated.View
            ...
            style={styles.shadowWrapperWrapper}
          >
            <TodayClassWidget schedule={schedule} />
          </Animated.View>
          ...
          >
            ...
            <View style={styles.infoGrid}>
              ...
              <InfoCard
                ...
                valueColor={
                  profile.situation.toLowerCase().includes("regular")
                    ? "#00C853"
                    : profile.situation.toLowerCase().includes("condicional")
                      ? "#FF9100"
                      : "#F44336"
                }
              />
        ...
        {!isAtBottom && (
          <View style={styles.scrollHint} pointerEvents="none">
            <LinearGradient
              colors={
                theme === "dark"
                  ? ["rgba(18, 18, 18, 0)", "rgba(18, 18, 18, 1)"]
                  : ["rgba(248, 249, 255, 0)", "rgba(248, 249, 255, 1)"]
              }
