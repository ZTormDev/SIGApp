...
const EXCLUDE_KEYWORDS = ["vespertino", "exclusivo para"];
...
function categorizeEvent(title: string): {
  ...
  if (
    lower.includes("término de clases") ||
    lower.includes("termino de clases")
  ) {
